        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="#"
                        class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Users
                        Edit
                    </a>
                </div>
            </li>
    ...
    <div class="w-full mx-auto">
        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="mx-auto py-6">
                ...
                <form id="myForm" action="{{ route('users.update', $user_data->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="f_name" id="f_name" value="{{ $user_data->f_name }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        ...
                        <div class="w-full">
                            ...
                            <input type="text" name="l_name" id="l_name" value="{{ $user_data->l_name }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                        ...
                        <div>
                            ...
                            <select id="genders" name="genders"
                                ...
                                <option value="male" @php echo $user_data->genders === 'male' ? 'selected': ''; @endphp>
                                    Male</option>
                                <option value="female" @php echo $user_data->genders === 'female' ? 'selected': ''; @endphp>
                                    Female</option>
                            </select>
                        </div>
                        <div>
